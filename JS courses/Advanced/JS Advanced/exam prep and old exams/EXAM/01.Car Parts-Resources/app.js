...
function solve() {
    ...
    let completeImgElement = document.querySelector('#complete-img');
    let completeTextElement = document.querySelector('#complete-text')
    ...
    function nextFnc(e){
            ...
            if (!carModel || !carYear || carYear < 1980 || carYear > 2023 || !partName || !partNumber || !condition){
                    return;
            }
